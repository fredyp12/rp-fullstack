...
class TableUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table_user" do
    assert_difference('TableUser.count') do
      post table_users_url, params: { table_user: { direccion: @table_user.direccion, documento: @table_user.documento, email: @table_user.email, name: @table_user.name, ocupacion: @table_user.ocupacion } }
    end
  ...
  test "should update table_user" do
    patch table_user_url(@table_user), params: { table_user: { direccion: @table_user.direccion, documento: @table_user.documento, email: @table_user.email, name: @table_user.name, ocupacion: @table_user.ocupacion } }
